...
NDefines.NBuildings.AIRBASE_CAPACITY_MULT = 300 --每级机场的容量
...
NDefines.NCountry.BASE_COMMAND_POWER_GAIN = 1 --每日指挥点数上限
...
NDefines.NMilitary.FIELD_EXPERIENCE_MAX_PER_DAY = 2 --每日经验获取上限
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.075  --原本是0.05 对黄条的伤害
NDefines.NMilitary.LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.05 --原本是0.053 对组织度的伤害
...
NDefines.NIndustrialOrganisation.ASSIGN_DESIGN_TEAM_PP_COST_PER_DAY = 0  ---使用军工组织研究每日消耗的政治点数，原版为0.1，设置为0则没有政治点花费
